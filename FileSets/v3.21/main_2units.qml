...
//////// show/hide the OverviewRelays2 page                                                                       
    VBusItem {                                                                   
        id: showOverviewRelays2                                                                               
        bind: "com.victronenergy.settings/Settings/GuiMods/ShowRelayOverview"             
        onValueChanged: extraOverview ("OverviewRelays2.qml", value === 1)                                
    }   

//////// show/hide the OverviewRelays3 page                                                              
    VBusItem {                                                                                           
        id: showOverviewRelays3                                                                          
        bind: "com.victronenergy.settings/Settings/GuiMods/ShowRelayOverview"                            
        onValueChanged: extraOverview ("OverviewRelays3.qml", value === 1)                               
    }
