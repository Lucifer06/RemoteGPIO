...
MbPage {
	...
	model: VisualModels {
		VisibleItemModel {
        	...
        	MbItemText {                                                               
            	text: qsTr("Relay module needs to be configured with Addr = 2. This applies for both RS485 and TCP protocols. When using TCP the Dingtian TCP server protocol must select RTU over TCP. Total number of relays for ALL connected modules MUST NOT exceed 16!")     
